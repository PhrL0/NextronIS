...
import EyeLooking from '@/shared/components/atom/lottie/eye-looking';
import Typography from '@/shared/components/atom/typography';
import { Carousel, CarouselContent, CarouselItem } from '@/shared/components/molecules/carousel';
...
Nossos sensores avançados monitoram condições ambientais e operacionais em tempo real, garantindo que você esteja sempre um passo à frente."
          ...
          <Flex align="center" justify="between" wrap="wrap">
            <Card className="h-52 min-w-3xs flex-1">
              <CardHeader>
              ...
              <CardContent>
                <CardDescription>
                  Mantenha seu sistema sob vigilância constante e receba alertas imediatos.
                </CardDescription>
              </CardContent>
            </Card>
            <Card className="h-52 min-w-3xs flex-1">
              ...
              <CardContent>
                <CardDescription>
                  Acesse dados e análises detalhadas para otimizar o desempenho dos seus dispositivos.
                </CardDescription>
              </CardContent>
            </Card>
            <Card className="h-52 min-w-3xs flex-1">
              ...
              <CardContent>
                <CardDescription>
                  Conecte rapidamente com outros sistemas e expanda suas funcionalidades.
                </CardDescription>
              </CardContent>
            </Card>
          </Flex>
...
const HeroSection = () => {
  const user = useUserDecode();
  return (
    <Flex justify="center" align="center" className="size-full overflow-hidden" vertical>
      <motion.div
        initial={{
          scale: 3,
          opacity: 0,
      ...
      <Flex vertical align="center" className="max-w-4xl">
        ...
        <motion.p
          ...
          className="relative z-10 mx-auto max-w-xl px-8 py-4 text-center text-lg font-normal text-neutral-600 dark:text-neutral-400"
        >
          Com nosso sistema baseado em IA, você acompanha o desempenho em tempo real, identifica falhas rapidamente e
          reduz o tempo de resposta — tudo em poucos minutos, não em dias.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0
...
const ResponsiveCard = ({ title, description, imageUrl }: { title: string; description: string; imageUrl: string }) => {
  return (
    <div className="group/card min-w-sm flex-1">
      <div
        className={cn(
          'relative mx-auto flex h-96 w-[100%] cursor-pointer flex-col justify-between overflow-hidden rounded-md bg-neutral-950 p-4 shadow-xl'
        )}
        style={{
      ...
      >
        <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-t from-black to-transparent opacity-75 transition duration-300 group-hover/card:to-black"></div>
        ...
        <div className="z-10">
          ...
          <p className="z-10 my-4 h-0 overflow-hidden text-sm font-normal text-ellipsis text-neutral-50/50 group-hover/card:h-auto group-hover/card:text-neutral-300">
            {description}
          </p>
        </div>
      </div>
